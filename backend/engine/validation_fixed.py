...
def walk_forward(fh,symbol,lookback=900,train_days=400,test_days=100,step=100):
    ...
    while i+train_days+test_days<=n:
        ...
        # Keep the exact OOS trades already simulated for this window.
        # Do not re-run the segment later: that can make the summary diverge
        # from the per-window results and does unnecessary work.
